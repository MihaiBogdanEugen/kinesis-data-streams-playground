package de.mbe.aws.tests.producer.kpl;
...
public final class StockTradesKPLAsyncProducer {

    private static final Logger LOGGER = LoggerFactory.getLogger(StockTradesKPLAsyncProducer.class);
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        final var kinesisAsyncClient = KinesisClientUtil.createKinesisAsyncClient(KinesisAsyncClient.builder()
